...
class GromacsConverter:
    def __init__(self, xtc_path, gro_path, xyz_filename):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert GROMACS XTC to XYZ, removing hydrogen atoms.")
    ...
    converter = GromacsConverter(args.xtc, args.gro, args.xyz)
    converter.convert()
